...
return
    [
        ...
        "This field is required to indicate the source of the file, for example: latifundist.com" => "Это поле необходимо для указания источника файла, например: latifundist.com",
